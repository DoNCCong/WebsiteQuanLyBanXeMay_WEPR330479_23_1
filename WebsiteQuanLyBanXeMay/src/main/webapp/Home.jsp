      ...
      <p class="card-text" style="text-align:center">Đảm bảo xu hướng mới, hiện đại cho khách hàng</p>
            ...
            <div class="container">
                            ...
                            <div class=" col-12 col-md-6 col-lg-3">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <p class="btn btn-success btn-block">${o.getStrGiaTien() } VNĐ</p>
                                            </div> 
                                        </div>
                                    </div>
                                </div>
             ...
             <div class="row" style="margin-top:25px">            
				<h1 style="text-align:center; width:100%" id="nike">XE VISION MỚI NHẤT</h1>
                    <div class="col-sm-12">
                        <div id="contentVision" class="row">
                        <c:forEach items="${list4NikeLast}" var="o">
                            <div class="productVision col-12 col-md-6 col-lg-3">
                                <div class="card">
                                 <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" src="${o.hinhAnh1}" alt="Card image cap">
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <p class="btn btn-success btn-block">${o.strGiaTien} VNĐ</p>
                                            </div>
                   ...
                   <button onclick="loadMoreVision()" class="btn btn-primary">Xem Thêm</button>
                </div>
            </div>
              ...
              <div class="row" style="margin-top:25px">            
				<h1 style="text-align:center; width:100%" id="adidas">XE AIRBLADE MỚI NHẤT</h1>
                    <div class="col-sm-12">
                        <div id="contentAirBlade" class="row">
                        <c:forEach items="${list4AdidasLast}" var="o">
                            <div class="productAirBlade col-12 col-md-6 col-lg-3">
                                <div class="card">
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" src="${o.hinhAnh1}" alt="Card image cap">
                                    </div>
                   ...
                   <button onclick="loadMoreAirBlade()" class="btn btn-primary">Xem Thêm</button>
                </div>
            </div>
        ...
        <script>
        	 ...
        	 function loadMore() {
                 ...
                 $.ajax({
                     url: "/WebsiteQuanLyBanXeMay/load",
        	 ...
        	 function loadMoreVision() {
                 var amountNike = document.getElementsByClassName("productVision").length;
                 $.ajax({
                     url: "/WebsiteQuanLyBanXeMay/loadVision",
                     type: "get", //send it through get method
                     data: {
                         exitsNike: amountNike
                     },
                     success: function (dataNike) {
                         document.getElementById("contentVision").innerHTML += dataNike;
        	 ...
        	 function loadMoreAirBlade() {
                 var amountAdidas = document.getElementsByClassName("productAirBlade").length;
                 $.ajax({
                     url: "/WebsiteQuanLyBanXeMay/loadAirBlade",
                     type: "get", //send it through get method
                     data: {
                         exitsAdidas: amountAdidas
                     },
                     success: function (dataAdidas) {
                         document.getElementById("contentAirBlade").innerHTML += dataAdidas;
             ...
             function searchByName(param){
                 ...
                 $.ajax({
                     url: "/WebsiteQuanLyBanXeMay/searchAjax",
                     type: "get", //send it through get method
                     data: {
                         txt: txtSearch
                     },
             ...
             function load(cateid){
             	 $.ajax({
                      url: "/WebsiteQuanLyBanXeMay/category",
                      type: "get", //send it through get method
                      data: {
                          cid: cateid
                      },
