      ...
      <section class="mb-5">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <p><span class="mr-1"><strong>${giaTienGiam } VNĐ</strong></span><span
                    class="text-grey"><strong><s>${detail.strGiaTien } VNĐ</s></strong></span></p>
            ...
            <div class="table-responsive">
              <table class="table table-sm table-borderless mb-0">
                <tbody>
                  ...
                  <tr>
                    <th class="pl-0 w-25" scope="row"><strong>Số Lượng Còn Lại: </strong></th>
                    <td>${detail.soLuongCon}</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div class="col-md-6 col-lg-3 mb-5">
            ...
            <div class="">
              ...
              <div class="pt-4">
                ...
                <h5>${o.title }</h5>
                <p><span class="text-danger mr-1"><strong>${giaTienGiam } VNĐ</strong></span><span
                    class="text-grey"><strong><s>${o.strGiaTien } VNĐ</s></strong></span></p>
